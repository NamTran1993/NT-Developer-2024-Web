                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="info-adress" style="text-align: initial;">
                                            Tầng 7, Toà nhà Shoutoku, 3−8−9 Sotokanda, Chiyoda-ku, Tokyo                           
                                        </p>
                                    </div>
                                </div>
                                <div class="row row-img">
                                    <div class="col-6">
                                        ...
                                        <p class="info-contact" style="text-align: start;">
                                            ...
                                            <a href="mailto:hr.jp@vnext.vn" class="footer-link-email">sales@vnext.vn                                </a>
                                        </p>
                                    </div>
                                    <div class="col-6">
                                        <a href="https://www.google.com/maps/place/VNEXT+JAPAN%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE/@35.7027959,139.7699265,18z/data=!4m5!3m4!1s0x60188d22f937d99b:0x4abf36996028e6e0!8m2!3d35.7027768!4d139.7709787" target="_blank" rel="noreferrer">
                                            <img class="img-map-info ls-is-cached lazyloaded" alt="VNext JAPAN" src="App_Themes/upload/2024/10/vnext-jp-map.png">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div id="address-hanoi" class="row-contact">
                                <div class="row">
                                    <div class="col-12">
                                        <img class="icon-footer-right ls-is-cached lazyloaded" alt="home" style="float: left;" src="App_Themes/upload/2024/10/home.svg">
                                        <p class="info-adress" style="text-align: initial;">
                                            Tầng 18-19-20, Tháp C, Toà nhà Central Point, 219 Trung Kính, phường Yên Hòa, quận Cầu Giấy, Hà Nội, Việt Nam                           
                                        </p>
                                    </div>
                                </div>
                                <div class="row row-img">
                                    <div class="col-6">
                                        ...
                                        <p class="info-contact" style="text-align: start;">
                                            <img class="icon-footer-right ls-is-cached lazyloaded" alt="email" src="App_Themes/upload/2024/10/email.svg">
                                            <a href="mailto:hr@vnext.vn" class="footer-link-email">info@vnext.vn                                </a>
                                        </p>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div id="address-danang" class="row-contact-da-nang">
                                <div class="row">
                                    <div class="col-12">
                                        <img class="icon-footer-right ls-is-cached lazyloaded" alt="home" style="float: left;" src="App_Themes/upload/2024/10/home.svg">
                                        <p class="info-adress" style="text-align: initial;">
                                            Tầng 3-5, Tòa nhà UST, số 639 Nguyễn Tất Thành, phường Xuân Hà, quận Thanh Khê, Đà Nẵng, Việt Nam                           
                                        </p>
                                    </div>
                                </div>
                                <div class="row row-img">
                                    <div class="col-6">
                                        <p class="info-contact" style="text-align: start;">
                                            <img class="icon-footer-right ls-is-cached lazyloaded" alt="phone-call" src="App_Themes/upload/2024/10/phone-call.svg">
                                            <a href="tel:02437659555" class="footer-link-email">024-3765-9555 (Ex:114)                                </a>
                                        </p>
                                        <p class="info-contact" style="text-align: start;">
                                            <img class="icon-footer-right ls-is-cached lazyloaded" alt="email" src="App_Themes/upload/2024/10/email.svg">
                                            <a href="mailto:hr@vnext.vn" class="footer-link-email">info@vnext.vn                                </a>
                                    ...
                                    <div class="col-6">
                                        <a href="https://www.google.com/maps/place/VNEXT+%C4%90%C3%A0+N%E1%BA%B5ng/@16.0721309,108.1987201,16z/data=!4m8!1m2!2m1!1sVnext!3m4!1s0x3142190e4a533d15:0x49738951be08656d!8m2!3d16.0728982!4d108.2004887" target="_blank" rel="noreferrer">
                                            <img class="img-map-info ls-is-cached lazyloaded" alt="VNext Da Nang" src="App_Themes/upload/2024/10/vnext-dn-map.png">
                                        </a>
                                    </div>
                                </div>
                            </div>
