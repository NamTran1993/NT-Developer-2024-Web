                    ...
                    <div>
                        <div class="c-form-head">
                            <div class="c-form-head__block">
                                <div class="c-form-head__title">Liên hệ chúng tôi</div>
                        ...
                        <div class="row">
                            <div class="large-10 is-push-lg-1 small-12">
                                <div id="mw_wp_form_mw-wp-form-7" class="mw_wp_form mw_wp_form_input" data-ng-show="bShowInfo">
                                    <div class="c-forms__text">Cảm ơn quý khách đã quan tâm đến LEON II</div>

                                    <div class="c-forms__block">
                                        <div class="c-forms__title">Tên công ty</div>
                                        <div class="c-forms__content">
                                            <div class="c-forms__input">
                                                <input type="text" size="60" placeholder="Công ty LEON II" data-ng-model="company" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="c-forms__block">
                                        ...
                                        <div class="c-forms__content">
                                            <div class="c-forms__input">
                                                <input type="text" size="60" placeholder="Nhân viên marketing" data-ng-model="department" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="c-forms__block">
                                        <div class="c-forms__title">Người liên hệ<span class="c-forms__label">cấn thiết</span></div>
                                        <div class="c-forms__content">
                                            <div class="c-forms__input">
                                                <input type="text" size="60" placeholder="Nguyễn Văn A" data-ng-model="personname" />
                                    ...
                                    <div class="c-forms__block">
                                        <div class="c-forms__title">Điện thoại<span class="c-forms__label">cấn thiết</span></div>
                                        <div class="c-forms__content">
                                            <div class="c-forms__input">
                                    ...
                                    <div class="c-forms__block">
                                        <div class="c-forms__title">Email<span class="c-forms__label">cấn thiết</span></div>
                                        <div class="c-forms__content">
                                            <div class="c-forms__input">
                                                <input type="text" size="60" placeholder="info@mail.com" data-ng-model="email" />
                                    ...
                                    <div class="c-forms__block">
                                        ...
                                        <div class="c-forms__content">
                                            <p>
                                                <small class="u-hidden-mw-wp-confirm">※Lưu ý file đính kèm không quá 3MB</small>
                                            </p>
                                    ...
                                    <div class="c-forms__block">
                                        ...
                                        <div class="c-forms__content">
                                            <div class="c-forms__textarea">
                                                <textarea name="お問い合わせ内容" cols="50" rows="5" placeholder="Hãy nhập nội dung liên hệ" data-ng-model="content"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="c-forms__submit">
                                        <button type="button" name="submit" value="send" class="c-button is-xlg" data-ng-click="send()">Gửi</button>
                                    </div>
                                </div>
