<%@ Page Title="" Language="C#" MasterPageFile="~/LayoutPage.master" AutoEventWireup="true" CodeFile="development.aspx.cs" Inherits="development" %>
    ...
    <div>
                        ...
                        <div class="c-block-slip-first__content">
                            ...
                            <div class="c-block-slip-first__block">
                                <div class="c-block-slip-first__figure">
                                    <img src="../../wp-content/themes/uluru-data-html/dist/assets/images/img-block-features-first-02.png" alt="">
                                </div>
        ...
        <section class="l-section is-xxxlg">
            <div class="c-block-solution">
                ...
                <div class="l-container">
                    <h2 class="c-heading is-lg is-center is-bottom"><span>Dự án nổi bật</span></h2>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="large-2 small-12">
                            <div class="c-flow__item">
                                ...
                                <div class="c-flow__item-icon">
                                    <img src="../../wp-content/themes/uluru-data-html/dist/assets/images/icon-flow-01.png" alt="">
                                </div>
                        ...
                        <div class="large-2 small-12">
                            <div class="c-flow__item">
                                ...
                                <div class="c-flow__item-icon">
                                    <img src="../../wp-content/themes/uluru-data-html/dist/assets/images/icon-flow-02.png" alt="">
                                </div>
                        ...
                        <div class="large-2 small-12">
                            <div class="c-flow__item">
                                ...
                                <div class="c-flow__item-icon">
                                    <img src="../../wp-content/themes/uluru-data-html/dist/assets/images/icon-flow-03.png" alt="">
                                </div>
                        ...
                        <div class="large-2 small-12">
                            <div class="c-flow__item">
                                ...
                                <div class="c-flow__item-icon">
                                    <img src="../../wp-content/themes/uluru-data-html/dist/assets/images/icon-flow-04.png" alt="">
                                </div>
                        ...
                        <div class="large-2 small-12">
                            <div class="c-flow__item">
                                ...
                                <div class="c-flow__item-icon">
                                    <img src="../../wp-content/themes/uluru-data-html/dist/assets/images/icon-flow-05.png" alt="">
                                </div>
                        ...
                        <div class="large-2 small-12">
                            <div class="c-flow__item  is-icon-hidden">
                                ...
                                <div class="c-flow__item-icon">
                                    <img src="../../wp-content/themes/uluru-data-html/dist/assets/images/icon-flow-06.png" alt="">
                                </div>
