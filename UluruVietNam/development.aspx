<%@ Page Title="Phát triển ứng dụng | LEON 2" Language="C#" MasterPageFile="~/LayoutPage.master" AutoEventWireup="true" CodeFile="development.aspx.cs" Inherits="development" %>
    ...
    <div>
        <div class="l-page-header " style="visibility: visible; opacity: 1;">
            <div class="l-page-header__container">
                <div class="l-page-header__image" style="background-image: url(App_Themes/upload/2024/10/page_detail01.jpg)">
                </div>
